...
            console.log ("[02] Ignore");
            console.log("[03] Back to settings")
            console.log ("===========================================================================")
            Login = Number(prompt("> "));
            
            if (Login == 1) {
...
console.log ("")
        console.log ("===========================================================================")
        console.log ("[EASTER EGGS ALREADY ACTIVATED]")
} else {
    console.log ("███████████████████████████████████████████████████████████████████")
console.log ("██                                                               ██")
console.log ("██                                        ████                   ██")
...
console.log ("")
        console.log ("===========================================================================")
        console.log ("[EASTER EGGS ALREADY DISABLED]")
} else {
    console.log ("███████████████████████████████████████████████████████████████████")
console.log ("██                                                               ██")
console.log ("██                    ████             ████                      ██")
...
console.log ("")
    ...
    console.log ("===========================================================================")
    console.log ("-> You have not selected a language! the version started will be in English.")
    console.log ("-> To change this, Follow the steps below")
    console.log ("-> [MENU] > [SETTINGS] > [LANGUAGE SELECTION].")
    pausarParaContinuar()
}
...
                process.stdin.pause();
                conquistas();
            } else if (selectedIndex === 4) { // Opção "CREDITS"
               process.stdin.setRawMode(false);
                process.stdin.pause();
console.log ("███████████████████████████████████████████████████████████████████")
console.log ("██                                                               ██")
...
console.log ("")
                ...
                console.log ("===========================================================================")
                console.log ("-> Programming: Lucas Eduardo and Kayc Félix (Ideas)")
                console.log ("-> Beta Testing: Kayc Félix, Isabella Sanches, Miguel Marconato and some friends")
                console.log ("-> Writing: Lucas Eduardo and some ideas from Miguel Marconato")
                console.log ("-> Art: Lucas Eduardo")
                console.log ("-> Music: Ryan Creep (Youtube.com)")
                console.log ("-> Special Thanks to: Miguel Marconato, Kayc Félix, Isabella Sanches and SENAI Team")
                console.log ("===========================================================================")
...
console.log ("")
                console.log ("===========================================================================")
                console.log ("[SUPPORT THE GAME]")
                console.log ("===========================================================================")
                console.log ("-> If you want to support the game's development, you can make a donation,")
                console.log ("any amount is welcome and greatly helps with the game's development!")
                console.log ("-> You can also leave a review on the game's page!")
                console.log ("===========================================================================")
                console.log ("-> Donation link: https://sadberry.itch.io/pale-luna")
                console.log ("===========================================================================")
                console.log ("[OPEN?]")
                console.log ("===========================================================================")
                console.log ("[01] Yes")
...
if (suporte == 1) {
    ...
    console.log ("[OPENING]")
    console.log ("===========================================================================")
    exec('start https://sadberry.itch.io/pale-luna')
} else if (suporte == 2) {
    console.clear()
    console.log ("===========================================================================")
