        ...
        if (carro == 1) {
            ...
            if (carro1 == 1) {
                ...
                if (fotopega && leufoto) {
                    ...
                    console.log ("---------------------------------------------------------------");
                    console.log ("-> Você completou o BAD_ENDING")
                    console.log ("---------------------------------------------------------------")
                    GOOD_ENDING=true
                    jogoAtivo4=false
        ...
        if (casa2 == 1) {
            ...
            if (mapa3 == 1) {
                ...
                if (cavar == 1) {
                    console.clear();
                    console.log ("---------------------------------------------------------------");
                    console.log ("-> Você começa a cavar o chão e nota uma silhueta de um ser-humano...")
...
if (BAD_ENDING) {
    exec('start cmd.exe /c A.exe')
    const conteudo = "VOCÊ COMPLETOU O PRIMEIRO FINAL RUIM";
fs.writeFileSync('../Conquistas/BAD_ENDING.bin', conteudo, 'utf8');

} else if (REAL_ENDING) {
    exec('start cmd.exe /c PoliceMonitor.exe', (error) => {
    if (error) {
    ...
    if (REAL_ENDING) {
        ...
        fs.writeFileSync('../Conquistas/REAL_ENDING.bin', conteudo1, 'utf8');
    }
});
} else if (GOOD_ENDING) {
        const conteudo2 = "VOCÊ COMPLETOU O FINAL BOM";
        fs.writeFileSync('../Conquistas/GOOD_ENDING.bin', conteudo2, 'utf8');
    } else if (BAD_ENDING_2) {
        const conteudo3 = "VOCÊ COMPLETOU O SEGUNDO FINAL RUIM";
        fs.writeFileSync('../Conquistas/BAD_ENDING_2.bin', conteudo3, 'utf8');
    } else if (BAD_ENDING_3) {
        const conteudo4 = "VOCÊ COMPLETOU O TERCEIRO FINAL RUIM";
        fs.writeFileSync('../Conquistas/BAD_ENDING_3.bin', conteudo4, 'utf8');
    }
