...
# Definir caminhos
arquivos1="$HOME/Pictures/Code_01.txt"
arquivos2="$HOME/Documents/Code_02.txt"
arquivos3="$HOME/Music/Code_03.txt"

# Garantir que as pastas existam, criando-as se necessário
