...
// Mensagem de início
console.log('[SISTEMA DE ARQUIVOS RESTRITOS - EXECUTANDO...]');
console.log(" ");

// Executa no terminal padrão do Linux
exec('x-terminal-emulator -e "./PoliceMonitor.sh"', (error) => {
    if (error) {
        console.error(`Erro ao executar o arquivo: ${error.message}`);
        return;
    }
    console.log('[SISTEMA DE ARQUIVOS RESTRITOS - ENCERRANDO...]');
});
